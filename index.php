    ...
    <div class="bg-img" class="float-container">
        ...
        <div id = "p" class="float-child">
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                <a class="nav-link" id = "item" href="#bg">Menu</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" id = "item" href="#">Bookings</a>
                </li>
                <li class="nav-item">
        ...
        <h1 id = "topic">Hotel Muruga Bhavan</h1>
    </div>
...
<div class="mySlides fade">
  <img src="https://www.holidify.com/images/cmsuploads/compressed/indian-1768906_1920_20180322173733.jpg" id="cardimg"style="width:100%;height:auto">

</div>

<div class="mySlides fade">
  <img src="https://6d1bdf0e0edb084eae10-5bfabe5484726969ac662c6d377e2f3c.ssl.cf2.rackcdn.com/themes/img/southindian-recipe1.jpg" id="cardimg"style="width:100%;height:auto">

</div>

<div class="mySlides fade">

  <img src="https://restaurantindia.s3.ap-south-1.amazonaws.com/s3fs-public/content6553.jpg" id="cardimg"style="width:100%;height:auto">
...
<div class="mySlides fade">
  ...
  <img src="http://2.bp.blogspot.com/-1Vy8ilCzfok/TacfNwOU_TI/AAAAAAAAAM8/50Y8NDG2FM8/s1600/Samabr.jpg" id="cardimg"style="width:100%;height:auto">
  
</div>

<div class="mySlides fade">
 
  <img src="https://media.istockphoto.com/photos/indian-butter-chicken-curry-picture-id177043240?k=6&m=177043240&s=612x612&w=0&h=h9_Y07ppShzZCbbuJXHX2y_ob1v6rQNP7r8467VOhb0=" id="cardimg"style="width:100%;height:auto">
  
</div>
<div class="mySlides fade">
  
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSr-eR9j8qiOxVGik6R5xaQrDBY8mZbcWZIfg&usqp=CAU" id="cardimg"style="width:100%;height:auto">
  
</div>
<div class="mySlides fade">

  <img src="https://cdn.shopify.com/s/files/1/1726/9835/articles/Indian_Sweets_1024x1024.jpeg?v=1517221761" id="cardimg"style="width:100%;height:auto">

</div>
<div class="mySlides fade">

  <img src="https://images.outlookindia.com/public/uploads/articles/2017/11/14/rosogolla_571_855.jpg" id="cardimg"style="width:100%;height:auto">
  
</div>
<div class="mySlides fade">

  <img src="https://i.ndtvimg.com/i/2016-03/kaju-barfi-625_625x350_81459346355.jpg" id="cardimg"style="width:100%;height:auto">
...
<br><br>
<button type="button" class="btn btn-danger" id="moremenu">More...</button>
<br>
<br>
</div>
...
<div class = "footer" id="contact">
  <i class="fa fa-phone" id="icon1"></i><a id="footericons" href="#">179823728932</a>
  <i class="fa fa-map-marker" id="icon2"></i><a id="footericons" href="#">8237829732</a>
  <i class="fa fa-envelope" id="icon3"></i><a id="footericons" href="mailto:ab@gmail.com">abc@gmail.com</a><br>
