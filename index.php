    ...
    <div class="bg-img" class="float-container">
        ...
        <div id = "p" class="float-child">
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                <a class="nav-link" id = "item" href="#menu">Menu</a>
                </li>
                <li class="nav-item">
...
Our restaurants serve South Indian, North Indian as well Chinese delicacies! We use the finest ingredients that allows us to serve the freshest quality food. We give utmost importance to hygiene and customer service, which will leave you wanting more!</p>
    </div>
<div id = "cards">
    <div class="gallery" alt = "food">
        <img src="food.jpg">
